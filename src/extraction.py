...
client names to canonical Fortune 500 identities via a JSON name mapping.
...
import re
import pandas as pd
from config import (LOBBYVIEW_DIR, NAME_MAPPING, OUTPUT_CSV, OUTPUT_ISSUES_CSV,
                    TARGET_CONGRESS, CONGRESS_FILING_YEARS)
